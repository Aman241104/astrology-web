...
export default function Navbar() {
  ...
  return (
    <header className="fixed top-0 w-full z-[1000]">
      ...
      {/* Main Nav */}
      <nav className="bg-white/95 backdrop-blur-md border-b border-gold/10 relative z-[1002]">
        <div className="max-w-7xl mx-auto px-4 h-14 md:h-20 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2 md:gap-3 group">
            <div className="w-8 h-8 md:w-12 md:h-12 bg-crimson rounded-full flex items-center justify-center group-hover:rotate-[360deg] transition-transform duration-1000">
      ...
      <div className="hidden md:block bg-crimson text-white py-1 px-4 border-t border-white/10 relative z-[1000]">
        <div className="max-w-7xl mx-auto flex items-center justify-between gap-4">
          ...
          <a href="tel:+919875958008" className="flex-1 md:flex-none flex items-center justify-center gap-3">
            ...
            <span className="text-sm md:text-lg font-black uppercase tracking-tighter">Get Permanent Love Problem Solution In One Call</span>
          </a>
