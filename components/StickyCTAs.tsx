  ...
  return (
    <div className="fixed bottom-0 left-0 w-full z-50 lg:hidden flex border-t-2 border-gold/10">
      <a 
        ...
        className="flex-1 bg-[#25D366] text-white py-4 flex items-center justify-center gap-2 font-black text-lg shadow-inner active:scale-95 transition-transform"
      >
