...
export default function ComparisonTable() {
  ...
  return (
    <section className="py-10 md:py-16 px-4 bg-white overflow-hidden relative">
      {/* Decorative Circles */}
                ...
                <thead>
                  <tr className="bg-cream/50">
                    ...
                    <th className="py-6 px-6 text-center border-b-2 border-saffron bg-saffron/5">
                       <div className="text-saffron font-black text-sm md:text-lg uppercase tracking-tight italic">Astro Pawan Swami</div>
                    </th>
